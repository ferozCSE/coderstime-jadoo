 ...
 * Slug: coderstime-jadoo/service-category
 * Categories: header
...
<div class="wp-block-group alignfull">
    <!-- wp:group {"align":"full","className":"relative-wrapper","style":{"spacing":{"padding":{"top":"5rem","bottom":"5rem","right":"1.25rem","left":"1.25rem"}}},"layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignfull relative-wrapper"
        ...
        <div class="wp-block-group">
            ...
            <figure class="wp-block-image alignright size-full is-resized decorative-image"><img
                    src="http://localhost/wp-content/uploads/2025/06/shape-1.png" alt="" class="wp-image-5281"
                    style="width:166px;height:auto" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:group -->
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:4rem">
        ...
        <div class="wp-block-columns alignfull" style="margin-bottom:0rem">
            <!-- wp:column {"className":"category-card","layout":{"type":"constrained"}} -->
            <div class="wp-block-column category-card">
                ...
                <div class="wp-block-group has-base-background-color has-background" style="border-radius:1rem">
                    ...
                    <div class="wp-block-group"
                        ...
                        <!-- wp:group {"layout":{"type":"constrained"}} -->
                        <div class="wp-block-group">
                            <!-- wp:image {"id":5266,"width":"70px","sizeSlug":"full","linkDestination":"none","align":"center","className":"section-card-icon is-style-default","style":{"spacing":{"margin":{"right":"0px","left":"0px"}},"border":{"radius":"100px","width":"0px","style":"none"}}} -->
                            <figure
                                class="wp-block-image aligncenter size-full is-resized has-custom-border section-card-icon is-style-default"
                                style="margin-right:0px;margin-left:0px"><img
                                    src="http://localhost/wp-content/uploads/2025/06/icon1.png" alt=""
                                    class="wp-image-5266"
            ...
            <div class="wp-block-column category-card">
                ...
                <div class="wp-block-group has-base-background-color has-background" style="border-radius:1rem">
                    ...
                    <div class="wp-block-group"
                        ...
                        <!-- wp:group {"layout":{"type":"constrained"}} -->
                        <div class="wp-block-group">
                            <!-- wp:image {"id":5267,"width":"70px","sizeSlug":"full","linkDestination":"none","align":"center","className":"section-card-icon is-style-default","style":{"spacing":{"margin":{"right":"0px","left":"0px"}},"border":{"radius":"100px","width":"0px","style":"none"}}} -->
                            <figure
                                class="wp-block-image aligncenter size-full is-resized has-custom-border section-card-icon is-style-default"
                                style="margin-right:0px;margin-left:0px"><img
                                    src="http://localhost/wp-content/uploads/2025/06/icon2.png" alt=""
                                    class="wp-image-5267"
                                    style="border-style:none;border-width:0px;border-radius:100px;width:70px" />
                            </figure>
                            <!-- /wp:image -->
            ...
            <div class="wp-block-column category-card">
                ...
                <div class="wp-block-group has-base-background-color has-background" style="border-radius:1rem">
                    ...
                    <div class="wp-block-group"
                        ...
                        <!-- wp:group {"layout":{"type":"constrained"}} -->
                        <div class="wp-block-group">
                            <!-- wp:image {"id":5268,"width":"70px","sizeSlug":"full","linkDestination":"none","align":"center","className":"section-card-icon is-style-default","style":{"spacing":{"margin":{"right":"0px","left":"0px"}},"border":{"radius":"100px","width":"0px","style":"none"}}} -->
                            <figure
                                class="wp-block-image aligncenter size-full is-resized has-custom-border section-card-icon is-style-default"
                                style="margin-right:0px;margin-left:0px"><img
                                    src="http://localhost/wp-content/uploads/2025/06/icon3.png" alt=""
                                    class="wp-image-5268"
                                    style="border-style:none;border-width:0px;border-radius:100px;width:70px" />
                            </figure>
                            <!-- /wp:image -->
            ...
            <div class="wp-block-column category-card">
                ...
                <div class="wp-block-group has-base-background-color has-background" style="border-radius:1rem">
                    ...
                    <div class="wp-block-group"
                        ...
                        <!-- wp:group {"layout":{"type":"constrained"}} -->
                        <div class="wp-block-group">
                            <!-- wp:image {"id":5269,"width":"70px","sizeSlug":"full","linkDestination":"none","align":"center","className":"section-card-icon is-style-default","style":{"spacing":{"margin":{"right":"0px","left":"0px"}},"border":{"radius":"100px","width":"0px","style":"none"}}} -->
                            <figure
                                class="wp-block-image aligncenter size-full is-resized has-custom-border section-card-icon is-style-default"
                                style="margin-right:0px;margin-left:0px"><img
                                    src="http://localhost/wp-content/uploads/2025/06/icon4.png" alt=""
                                    class="wp-image-5269"
                                    style="border-style:none;border-width:0px;border-radius:100px;width:70px" />
                            </figure>
                            <!-- /wp:image -->

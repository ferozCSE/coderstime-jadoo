 ...
 * Slug: coderstime-jadoo/newsletter-section
 * Categories: header
...
<!-- wp:group {"align":"wide","className":"news-letter-container","style":{"spacing":{"padding":{"top":"40px","bottom":"40px","right":"0px","left":"0px"},"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide news-letter-container"
    style="padding-top:40px;padding-right:0px;padding-bottom:40px;padding-left:0px">
    <!-- wp:group {"layout":{"type":"constrained"}} -->
    <div class="wp-block-group">
        <!-- wp:image {"id":5467,"scale":"cover","sizeSlug":"full","linkDestination":"none","className":"news-shape-bg2"} -->
        <figure class="wp-block-image size-full news-shape-bg2"><img
                src="http://localhost/wp-content/uploads/2025/06/shape-bg2.png" alt="" class="wp-image-5467"
    ...
    <!-- wp:group {"layout":{"type":"constrained"}} -->
    <div class="wp-block-group">
        <!-- wp:group {"style":{"spacing":{"margin":{"top":"5rem"}}},"layout":{"type":"constrained"}} -->
    ...
    <!-- wp:group {"layout":{"type":"constrained"}} -->
    <div class="wp-block-group">
        <!-- wp:image {"id":5469,"width":"300px","height":"auto","sizeSlug":"full","linkDestination":"none","className":"news-shape-bg1 is-style-default","style":{"spacing":{"margin":{"top":"0rem","bottom":"0"}}}} -->
        <figure class="wp-block-image size-full is-resized news-shape-bg1 is-style-default"
            style="margin-top:0rem;margin-bottom:0"><img src="http://localhost/wp-content/uploads/2025/06/shape-bg1.png"
                alt="" class="wp-image-5469" style="width:300px;height:auto" /></figure>
        <!-- /wp:image -->
    </div>
    <!-- /wp:group -->
</div>

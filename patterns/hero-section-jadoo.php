<?php
/**
 * Title: Hero Section Jadoo
 * Slug: coderstime-jadoo/hero-section-jadoo
 * Categories: header
...
<!-- wp:cover {"customOverlayColor":"#f5f7fa","isUserOverlayColor":true,"minHeight":34,"minHeightUnit":"rem","contentPosition":"center center","isDark":false,"metadata":{"categories":["header"],"patternName":"codersblocks/header-hero-section","name":"Header Hero Section"},"align":"full","className":"hero-pattern","layout":{"type":"default"}} -->
<div class="wp-block-cover alignfull is-light hero-pattern" style="min-height:34rem"><span aria-hidden="true"
    ...
    <div class="wp-block-cover__inner-container">
        <!-- wp:cover {"url":"http://localhost/wp-content/uploads/2025/06/hero-bg-4.png","id":5370,"dimRatio":0,"overlayColor":"base","isUserOverlayColor":true,"focalPoint":{"x":0,"y":0.5},"minHeight":804,"minHeightUnit":"px","contentPosition":"center center","isDark":false,"sizeSlug":"full","align":"center","layout":{"type":"default"}} -->
        <div class="wp-block-cover aligncenter is-light" style="min-height:804px"><img
                ...
                src="http://localhost/wp-content/uploads/2025/06/hero-bg-4.png" style="object-position:0% 50%"
                data-object-fit="cover" data-object-position="0% 50%" /><span aria-hidden="true"
            ...
            <div class="wp-block-cover__inner-container">
                ...
                <div class="wp-block-group alignwide">
                    <!-- wp:columns {"align":"wide","className":"p-animation-text-moveUp","style":{"spacing":{"blockGap":{"left":"3rem"},"padding":{"bottom":"0"}},"border":{"radius":"0px","width":"0px","style":"none"}}} -->
            ...
            Destinations around the world', 'coderstime-jadoo' ); ?></p>
                            ...
                            <h1 class="wp-block-heading has-text-primary-color has-text-color"
                                ...
                                <?php esc_html_e( 'Travel, enjoy and live a new and full life', 'coderstime-jadoo' ); ?>
                            </h1>
                            <!-- /wp:heading -->
            ...
            itself do in it.<br>Preferred to sportsmen it engrossed listening. Park gate<br>sell they west hard for the.', 'coderstime-jadoo' ); ?>
                        ...
                        More', 'coderstime-jadoo' ); ?></a></div>
                                ...
                                <figure class="wp-block-image size-full is-resized play-btn"><img
                                        src="http://localhost/wp-content/uploads/2025/06/play.png" alt=""
                                        class="wp-image-5253" style="width:49px;height:auto" /></figure>
                                <!-- /wp:image -->

                                <!-- wp:paragraph {"fontSize":"medium"} -->
                                <p class="has-medium-font-size"><?php esc_html_e( 'Play Demo', 'coderstime-jadoo' ); ?>
                                </p>
                                <!-- /wp:paragraph -->
                            </div>
                            <!-- /wp:group -->
                        ...
                        <!-- wp:column {"verticalAlignment":"center"} -->
                        <div class="wp-block-column is-vertically-aligned-center">
                            <!-- wp:image {"id":5258,"width":"748px","sizeSlug":"full","linkDestination":"none","className":"rounded-xl overflow-hidden shadow-2xl is-style-default"} -->
                            <figure
                                class="wp-block-image size-full is-resized rounded-xl overflow-hidden shadow-2xl is-style-default">
                                <img src="http://localhost/wp-content/uploads/2025/06/hero-img.png" alt=""
                                    class="wp-image-5258" style="width:748px" />
                            </figure>
                            <!-- /wp:image -->
                        </div>
                        <!-- /wp:column -->

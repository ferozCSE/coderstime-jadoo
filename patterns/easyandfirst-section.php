 ...
 * Slug: coderstime-jadoo/easyandfirst-section
 * Categories: header
...
<!-- wp:cover {"customOverlayColor":"#f5f7fa","isUserOverlayColor":true,"minHeightUnit":"rem","isDark":false,"metadata":{"categories":["header"],"patternName":"codersblocks/header-hero-section","name":"Header Hero Section"},"align":"full","className":"hero-pattern"} -->
        ...
        <div class="wp-block-group">
            ...
            <div class="wp-block-columns alignwide">
                            ...
                            <div class="wp-block-group">
                                ...
                                <div class="wp-block-columns">
                                    ...
                                    <div class="wp-block-column book-icon-wrapper" style="flex-basis:20%">
                                        <!-- wp:image {"id":5413,"width":"20px","sizeSlug":"full","linkDestination":"none","className":"book-icon"} -->
                                        <figure class="wp-block-image size-full is-resized book-icon"><img
                                                src="http://localhost/wp-content/uploads/2025/06/selection.png" alt=""
                                                class="wp-image-5413" style="width:20px" /></figure>
                                        <!-- /wp:image -->
                                    </div>
                                    <!-- /wp:column -->
                            ...
                            <div class="wp-block-group">
                                ...
                                <div class="wp-block-columns">
                                    ...
                                    <div class="wp-block-column book-icon-wrapper2" style="flex-basis:20%">
                                        <!-- wp:image {"id":5419,"width":"20px","sizeSlug":"full","linkDestination":"none","className":"book-icon"} -->
                                        <figure class="wp-block-image size-full is-resized book-icon"><img
                                                src="http://localhost/wp-content/uploads/2025/06/water-sport.png" alt=""
                                                class="wp-image-5419" style="width:20px" /></figure>
                                        <!-- /wp:image -->
                                    </div>
                                    <!-- /wp:column -->
                            ...
                            <div class="wp-block-group">
                                ...
                                <div class="wp-block-columns">
                                    ...
                                    <div class="wp-block-column book-icon-wrapper3" style="flex-basis:20%">
                                        <!-- wp:image {"id":5420,"width":"20px","sizeSlug":"full","linkDestination":"none","className":"book-icon"} -->
                                        <figure class="wp-block-image size-full is-resized book-icon"><img
                                                src="http://localhost/wp-content/uploads/2025/06/taxi.png" alt=""
                                                class="wp-image-5420" style="width:20px" /></figure>
                                        <!-- /wp:image -->
                                    </div>
                                    <!-- /wp:column -->
                ...
                <div class="wp-block-column"
                    ...
                    <!-- wp:cover {"url":"http://localhost/wp-content/uploads/2025/06/bg-1.png","id":5393,"dimRatio":20,"customOverlayColor":"#54b3e6","isUserOverlayColor":false,"minHeight":306,"minHeightUnit":"px","isDark":false,"sizeSlug":"full","style":{"spacing":{"padding":{"top":"0rem","right":"0rem","bottom":"0rem","left":"0rem"},"margin":{"top":"8.4rem","bottom":"0rem"}},"border":{"radius":"11px"}},"layout":{"type":"constrained"}} -->
                    <div class="wp-block-cover is-light"
                        ...
                        <img class="wp-block-cover__image-background wp-image-5393 size-full" alt=""
                            src="http://localhost/wp-content/uploads/2025/06/bg-1.png" data-object-fit="cover" /><span
                            aria-hidden="true"
                            class="wp-block-cover__background has-background-dim-20 has-background-dim"
                            style="background-color:#54b3e6"></span>
                        <div class="wp-block-cover__inner-container">
                            <!-- wp:group {"style":{"border":{"radius":"0px"}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
                            <div class="wp-block-group has-base-background-color has-background"
                                style="border-radius:0px">
                                <!-- wp:image {"id":5353,"sizeSlug":"full","linkDestination":"none","align":"wide","style":{"border":{"radius":"0.9rem"}}} -->
                                <figure class="wp-block-image alignwide size-full has-custom-border"><img
                                        src="http://localhost/wp-content/uploads/2025/06/booking-img.jpg" alt=""
                                        class="wp-image-5353" style="border-radius:0.9rem" /></figure>
                                <!-- /wp:image -->

                                <!-- wp:group {"style":{"spacing":{"padding":{"top":"1.4rem","right":"1.4rem","bottom":"1.4rem","left":"1.4rem"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
                                <div class="wp-block-group has-base-background-color has-background"
                                    ...
                                    <div class="wp-block-group">
                                        ...
                                        <div class="wp-block-group"
                                            ...
                                            <div class="wp-block-group easy-icon-wrapper">
                                                ...
                                                <figure
                                                    ...
                                                    <img src="http://localhost/wp-content/uploads/2025/06/map.png"
                                            ...
                                            <div class="wp-block-group easy-icon-wrapper">
                                                ...
                                                <figure
                                                    class="wp-block-image size-full is-resized is-style-rounded easy-icon">
                                                    <img src="http://localhost/wp-content/uploads/2025/06/send.png"
                                        ...
                                        <div class="wp-block-group">
                                            ...
                                            <figure class="wp-block-image size-full"><img
                                                    src="http://localhost/wp-content/uploads/2025/06/building.png"
                                            ...
                                            <figure class="wp-block-image size-full" style="margin-left:9.5rem"><img
                                                    src="http://localhost/wp-content/uploads/2025/06/heart.png" alt=""
                                                    class="wp-image-5410" /></figure>
                                            <!-- /wp:image -->
                                        </div>
                                        <!-- /wp:group -->
                                    </div>
